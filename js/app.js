...
sr.reveal('.container-text, #wrapper, .container-info, .about-text, .about-my, .about-info, .skillls-text, .cards,.html-pai, .css-pai, .py-pai, .js-pai, .c-pai, .my-pai, .contando-text, .cont-text, .by-pk', { duration: 2000 });
